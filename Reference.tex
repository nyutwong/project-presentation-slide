...
AI Engine & Multi-agent ReAct reasoning (CrewAI) with HyDE query expansion and MCP tool integration. & Python FastAPI, CrewAI \\ \hline
...
\subsection{AI Engine: CrewAI Flow Architecture}
